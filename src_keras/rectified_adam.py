...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug 17 21:41:20 2019
https://github.com/CyberZHG/keras-radam
https://www.kaggle.com/virtualdvid/wildlife-keras-radam-rectified-adam-optimazer
@author: mzhao
"""
...
class RAdam(optimizers.Optimizer):
    ...
    def get_updates(self, loss, params):
        ...
        if self.initial_decay > 0:
            lr = lr * (1. / (1. + self.decay * K.cast(self._iterations, K.dtype(self.decay))))
